...
const VehiclePanel = (props) => {
  return (
    <div>
      ...
      }} className='opacity-1  text-center w-[93%] absolute top-0'>
      ...
      <div onClick={() => {
        ...
        <img className='h-10' src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_638,w_956/v1682350114/assets/c2/296eac-574a-4a81-a787-8a0387970755/original/UberBlackXL.png" alt="" />
